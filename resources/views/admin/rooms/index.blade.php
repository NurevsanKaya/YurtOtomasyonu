                    ...
                    <table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
                        <thead>
                            <tr class="text-left">
                                ...
                                <th class="bg-gray-50 sticky top-0 border-b border-gray-200 px-6 py-3 text-gray-600 font-bold tracking-wider uppercase text-xs">Mevcut Öğrenci</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <!-- Oda verileri buraya dinamik olarak eklenecek -->
                        </tbody>
                    </table>
                </div>
            </div>
